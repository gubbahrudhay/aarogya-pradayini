...
const team = [
  ...
  { name: 'Dr. Kranthi / Dr. Kranti', initials: 'DK', color: 'from-cyan-500 to-cyan-700', role: 'Medical Specialist' },
  { name: 'Dr. Kavitha', initials: 'DK', color: 'from-sky-500 to-sky-700', role: 'Medical Specialist' },
  { name: 'Dr. Krishna Veeramalla / Dr. Krishna', initials: 'KV', color: 'from-violet-500 to-violet-700', role: 'Medical Specialist' },
  ...
  { name: 'Dr. Sai Shree Gubba', initials: 'SG', color: 'from-orange-500 to-orange-700', role: 'Medical Specialist' },
  { name: 'Dr. Sharath Chandra', initials: 'SC', color: 'from-red-500 to-red-700', role: 'Medical Specialist' },
  { name: 'Dr. Shushma Chithanuri / Dr. Sushma', initials: 'SC', color: 'from-teal-500 to-teal-700', role: 'Medical Specialist' },
  { name: 'Dr. Sindhu', initials: 'DS', color: 'from-purple-500 to-purple-700', role: 'Medical Specialist' },
  { name: 'Dr. Sowmya', initials: 'DS', color: 'from-green-500 to-green-700', role: 'Medical Specialist' },
  { name: 'Dr. Sridhar', initials: 'DS', color: 'from-indigo-500 to-indigo-700', role: 'Eye Specialist' },
  ...
  { name: 'Dr. Supraja', initials: 'DS', color: 'from-emerald-500 to-emerald-700', role: 'Medical Specialist' },
  { name: 'Dr. Venkat Swamy Veeramalla', initials: 'VV', color: 'from-cyan-500 to-cyan-700', role: 'Medical Specialist' },
  { name: 'Dr. Vidya Sagar', initials: 'VS', color: 'from-sky-500 to-sky-700', role: 'Medical Specialist' },
  { name: 'Dr. Vijay Kumar', initials: 'VK', color: 'from-violet-500 to-violet-700', role: 'Medical Specialist' },
  { name: 'Dr. Vinay', initials: 'DV', color: 'from-rose-500 to-rose-700', role: 'Medical Specialist' },
  { name: 'Dr. Yashwanth Raani', initials: 'YR', color: 'from-fuchsia-500 to-fuchsia-700', role: 'Medical Specialist' },
];
